...
public abstract class BaseController   {
    ...
    protected ResultEntity inputValid(String param, String schemaName) {
    	 ...
    	 RequestParamModel paramModel = Common.CheckRequestParams(param);
         ...
         if (validJson != null) {
             ...
             return new ResultEntity(ResultEntity.RESULT_CODE_ERROR, "ApiMsg3001", new String[]{errorMessage}, null);
         }
